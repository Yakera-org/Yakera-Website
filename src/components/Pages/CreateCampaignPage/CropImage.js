...
class CropImage extends React.Component {
  ...
  async updateDestination() {
    ...
    var cropped_image = new File([u8arr], this.props.image.name, {
    ...
    this.setState({
      filePreview: (
        <>
          ...
          <FilePreview
            EN={this.props.EN}
            prev={this.state.imageDestination}
            key={cropped_image.name}
            file={cropped_image}
            onRemove={this.props.onRemove}
            onRetry={this.props.onRetry}
            id="main"
            uploadSuccess={this.props.uploadSuccess}
            uploadFailures={this.props.uploadFailures}
          />
        </>
      ),
    });
    ...
    return (
      <div className="crop-container">
        ...
        <div id="result" style={{ visibility: "hidden" }}>
          ...
          <span className="fa-stack">
            ...
            <i
              ...
              className="far fa-stack-2x fa-2x fa-times-circle"
            ></i>
          </span>
        </div>
        ...
        <div id="cropandupload" style={{ visibility: "hidden" }}>
          <input
            type="button"
            value={this.props.EN ? "Upload" : "Cargar"}
            className="btn upld-btn"
