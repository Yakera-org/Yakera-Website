...
function PaymentAuth(props) {
  ...
  const total_amount =
    Math.round(
      (parseFloat(props.amount) + parseFloat(props.tip)) * Math.pow(10, 2)
    ) / Math.pow(10, 2);
    ...
    <div>
      ...
      <Card className="payment-auth-card">
        <div className="auth-axplanation">
          <h4>
            {EN ? "Amount to be donated:" : "Monto a donar:"}{" "}
            <label style={{ color: "#ea8737" }}>${total_amount} USD</label>
          </h4>
          <p>
            {EN
        ...
        <Accordion>
          <AccordionCard>
            <Accordion.Toggle
              ...
              onClick={onPaymentAuthClick}
              eventKey="0"
              className="reserve-but align-items-center d-flex justify-content-center"
            >
              <div name="reserve">
                <img
                  name="reserve"
          ...
          <Accordion>
            <AccordionCard>
              <Accordion.Toggle
                ...
                onClick={onPaymentAuthClick}
                eventKey="0"
                className="zelle-but align-items-center d-flex justify-content-center"
              >
                <div name="zelle">
