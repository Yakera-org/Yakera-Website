      ...
      <div>
        ...
        >
          ...
          <div className='cam-img' >
            <img 
            style={{
              minHeight:'21em', // 21em scales the image based on font size; the scaling factor is, however, absolute
                                // 21 seems to give the images a big enough size for the cards
              minWidht:'100%',
              maxHeight: '21em'
            }}
              width="100%"
          ...
          <CardContent > 
            <Grid container spacing = {1}>
                ...
                <Grid item xs = {12}>
                    <div className='description' style = {{minHeight: '5em', maxHeight: '5em'}}>
                      <p>              
                        {description}
                      </p>
                    </div>
