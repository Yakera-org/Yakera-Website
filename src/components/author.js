              ...
              <div className="row">
                <div className="mr-2 vertical-align">
                  <button
                    id="link"
                    name="contact"
                    onClick={EN ? sendMail : contactUs}
                  >
                    {EN ? "Contact Us" : "Contáctanos"}
                  </button>
                </div>
                <div className="mx-2 vertical-align">
                  <button id="link" name="about" onClick={onLinkClick}>
                    {EN ? "About Us" : "Sobre nosotros"}
                  </button>
                </div>
                <div className="ml-2 vertical-align">
                  <button id="link" name="terms" onClick={onLinkClick}>
                    {EN ? "Terms & Conditions" : "Términos y condiciones"}
                  </button>
                </div>
              </div>
            )}
            <div className="row right-margin">{socialMediaIcons}</div>
          </div>
        </div>
      </div>
